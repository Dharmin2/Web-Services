...
$url = "http://localhost/api/MyItems.php";
$curl = curl_init($url);
...
if ($resp != null) {
    ...
    // Get the object.
        ...
        // Get the actual presigned-url
            ...
            echo "<a href='../Views/EditProduct.php?id=$myData[0]'>Edit this item</a><br>";
            echo "<a href='../Controllers/DeleteItemController.php?id=$myData[0]'>Delete this item</a><br>";
